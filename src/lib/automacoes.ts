...
export const AUTOMACOES: Automacao[] = [
  ...
  { icone: "🔁", nome: "Ponte Radar → Instagram (de hora em hora)", usaIA: false, custo: "zero" },
  { icone: "💡", nome: "Donna captura ideias de conteúdo (link IG → banco Conteúdos)", usaIA: true, custo: "Gemini, centavos por captura" },
  ...
  { icone: "🔍", nome: "Mike busca notícias (30 em 30 min, ~28 fontes, detector UAU + caso de uso)", usaIA: false, custo: "zero — IA só entra na escrita" },
  { icone: "✍️", nome: "Izzy escreve posts e dicas (UAU sai na hora)", usaIA: true, custo: "notícias via Claude (assinatura); dicas via Gemini" },
  { icone: "🎬", nome: "Pautas e roteiros de reels (com ciclo de feedback)", usaIA: true, custo: "1 chamada por pauta/roteiro/regravação" },
